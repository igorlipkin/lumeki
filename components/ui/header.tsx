      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <NavLink href="/articles" active={pathname === '/articles' || pathname.startsWith('/articles/')}>
              Blog
            </NavLink>
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-200 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex flex-col space-y-4">
              ...
              <MobileNavLink href="/articles" active={pathname === '/articles' || pathname.startsWith('/articles/')}>
                Blog
              </MobileNavLink>
